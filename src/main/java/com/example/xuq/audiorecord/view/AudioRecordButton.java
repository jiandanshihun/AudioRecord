package com.example.xuq.audiorecord.view;
...
import com.example.xuq.audiorecord.manager.AudioManager;
import com.example.xuq.audiorecord.manager.DialogManager;
...
public class AudioRecordButton extends android.support.v7.widget.AppCompatButton implements AudioManager.AudioStageListener {
    ...
    public AudioRecordButton(Context context, AttributeSet attrs) {
        ...
        // 这里没有判断储存卡是否存在，有空要判断
        String dir = Environment.getExternalStorageDirectory().getAbsolutePath()+"/xuqiangtest";
        Log.v("xq","dir is "+dir);
