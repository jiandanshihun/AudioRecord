...
import com.example.xuq.audiorecord.manager.MediaManager;
import com.example.xuq.audiorecord.view.AudioRecordButton;
...
public class RecordActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        audio.setStreamVolume(AudioManager.GET_DEVICES_INPUTS,11,0);//试图将mic增益调到最大
